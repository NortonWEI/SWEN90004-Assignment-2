...
MAP_HEIGHT: int = 20                # Height of the patch map (i.e. the number of patches in y direction).
MAP_WIDTH: int = 20                 # Width of the patch map (i.e. the number of patches in x direction).
